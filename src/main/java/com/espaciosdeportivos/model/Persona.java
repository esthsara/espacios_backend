...
import com.fasterxml.jackson.annotation.JsonIgnore; // <--- IMPORTANTE: Agrega este import
...
public class Persona {
    ...
    // use Lazi por que Solo carga esta relación cuando yo la pida explícitamente en
    // el código."
    ...
    @JsonIgnore // <--- ¡ESTO ES LA SOLUCIÓN!
    private List<Qr> qrs;
